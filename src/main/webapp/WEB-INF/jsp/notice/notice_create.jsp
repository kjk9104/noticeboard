...
<div class="d-flex justify-content-center">
	<div class="post_content">
		...
		<div class="d-flex justify-content-end">
			<button id="savaBtn" type="button" class="btn btn-primary mr-3 mt-3">저장</button>
			<button id="clearBtn" type="button" class="btn btn-secondary mt-3">모두지우기</button>
		</div>  
     </div>
	</div>
</div>
